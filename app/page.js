...
export default function Home() {
  ...
  const runSprint = async()=>{
    ...
    try{
      ...
      const trimmed = researchText.length > 12000 ? researchText.substring(0, 12000) + "\n\n[TRUNCATED — use available data]" : researchText;
      setSprintPhase("analyzing");
      const formatted = await callClaude({
        system:FORMAT_SYS,
        max_tokens:16000,
        messages:[{role:"user",content:`Here is raw research data from live web searches about trending dropshipping products with weak UK competition. Convert this into the exact niche JSON format.\n\nIMPORTANT RULES:\n- Use REAL data from the research below — real prices, real competitor names, real URLs found\n- If data is missing, use conservative estimates and note "estimated" in the relevant field\n- Score competition weakness HIGH if few/no UK branded stores were found\n- Calculate all unit economics properly (COGS, margins, CPA, ROAS, etc)\n- Be honest in scores — don't inflate\n- For launchChecklist: pass=true ONLY if criterion is genuinely met. Be strict.\n\nRESEARCH DATA:\n${trimmed}\n\nReturn the data as: {"niches":[...]} using this exact structure for each niche:\n{"name":"...","tagline":"...","heroProduct":"...","sourcing":{"platforms":["CJDropshipping","1688","AliExpress"],"searchTerms":["t1","t2"],"estimatedProductCostGBP":0,"estimatedShippingToUKGBP":0,"estimatedShippingDays":"10-18","moqForWhiteLabel":"50-100","whitelabelFeasibility":"Easy/Medium/Hard","packagingCustomisation":"..."},"unitEconomics":{"retailPriceGBP":0,"productCostGBP":0,"shippingToUKGBP":0,"totalCOGS":0,"shopifyTransactionFee":0,"paymentProcessingFee":0,"grossProfitPerUnit":0,"grossMarginPercent":0,"estimatedCPAatBreakeven":0,"targetCPA":0,"netProfitPerUnitAfterAds":0,"netMarginAfterAds":0,"breakEvenROAS":0,"targetROAS":0,"monthlyRevenueAt5OrdersPerDay":0,"monthlyProfitAt5OrdersPerDay":0,"subscriptionLTV12Months":0},"subscriptionAngle":"...","problem":"...","whyNow":"...","audience":"...","metaAdAngle":"...","emotionalDriver":"...","competitors":"...","brandingOpportunity":"...","contentFlywheel":"...","moat":"...","fastMVP":"...","longTermVision":"...","scores":{"demand":{"score":0,"reason":"..."},"competitionWeakness":{"score":0,"reason":"..."},"brandingPotential":{"score":0,"reason":"..."},"profitability":{"score":0,"reason":"..."},"virality":{"score":0,"reason":"..."},"retention":{"score":0,"reason":"..."},"scalability":{"score":0,"reason":"..."},"communityPotential":{"score":0,"reason":"..."},"seoOpportunity":{"score":0,"reason":"..."},"defensibility":{"score":0,"reason":"..."}},"launchChecklist":{"solvesRealProblem":{"pass":true,"reason":"..."},"profitMarginGreenZone":{"pass":true,"reason":"Gross margin must be >60%"},"lightweight":{"pass":true,"reason":"Under 500g"},"upsellPotential":{"pass":true,"reason":"List upsell products"},"notSeasonal":{"pass":true,"reason":"Year-round demand"},"validatedNotSaturated":{"pass":true,"reason":"Proven demand, fewer than 3 branded UK competitors"}},"brandIdeas":{"names":["N1","N2","N3"],"positioning":"...","visualDirection":"...","messagingStrategy":"...","contentPillars":["P1","P2","P3"]}}\n\nReturn ONLY valid JSON. No markdown. No backticks.`}]
      });
